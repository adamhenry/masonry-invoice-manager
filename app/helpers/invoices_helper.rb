module InvoicesHelper
  ...
  def render_action_button tag, obj
      render :partial => "action_button", :locals => { :tag => tag, :obj => obj }
  end
  ...
  def render_invoice_link_to_confirm obj
    #render_link_to_confirm 'Invoice', :get, obj if obj.can_invoice?
    link_to 'Invoice',
      '/invoices/invoice/' + obj.id.to_s,
      :confirm => "Are you sure?\n You will no longer be able to Change Items on the invoice." if obj.can_invoice?
  end
